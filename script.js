...
const scenarios = [
  {
    text: "สถานการณ์ที่ 1 – นักเรียนส่งโพยข้อสอบให้กัน\nคุณจะทำอย่างไร?",
    options: [
  ...
  {
    text: "สถานการณ์ที่ 2 – ปลอมลายเซ็นต์ตรวจสมุด\nคุณจะทำอย่างไร?",
    options: [
  ...
  {
    text: "สถานการณ์ที่ 3 – ครูกรีฑารับเงินให้สีชนะ\nคุณจะทำอย่างไร?",
    options: [
  ...
  {
    text: "สถานการณ์ที่ 4 – เหรัญญิกนำเงินไปใช้ส่วนตัว\nคุณจะทำอย่างไร?",
    options: [
  ...
  {
    text: "สถานการณ์ที่ 5 – เพื่อนครูปรับคะแนนนักเรียนเกินจริง\nคุณจะทำอย่างไร?",
    options: [
